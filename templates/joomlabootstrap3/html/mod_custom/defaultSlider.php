...
================================================== -->
<div id="myCarousel"
     class="carousel slide custom<?php echo $moduleclass_sfx ?>"
     data-ride="carousel"
			...
			<div class="container">
				<div class="carousel-caption">
					...
					<p>Note: If you're viewing this page via a <code>file://</code> URL, the "next" and "previous"
						Glyphicon buttons on the left and right might not load/display properly due to web browser security
						rules.</p>
