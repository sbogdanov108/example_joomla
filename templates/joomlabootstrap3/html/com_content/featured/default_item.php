  ...
  <div class="row featurette">
    <div class="col-md-7 <?= ( $this->number % 2 ) ? '' : 'col-md-push-5' ?> ">
      <?php if ( $params->get( 'show_title' ) ) : ?>
        <h2 class="featurette-heading" itemprop="name">
    ...
    <div class="col-md-5 <?= ( $this->number % 2 ) ? '' : 'col-md-pull-7' ?>">
      <?php if ( isset( $images->image_intro ) && ! empty( $images->image_intro ) ) : ?>
        ...
        <div class="featurette-image img-responsive center-block pull-<?php echo htmlspecialchars( $imgfloat ); ?> item-image"><img
